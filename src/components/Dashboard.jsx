...
function Dashboard() {
    ...
    const { pendingRefunds, accounts, goals } = useExpenses();
    ...
    const available = monthlyIncome - monthlySpent;
    const isDanger = available < budget.reserved;
        ...
        <div className="dashboard-container">
            ...
            <div className="stats-grid">
                ...
                <div className="card total-card" style={{ borderLeft: '4px solid #FFA000' }}>
                    ...
                    <p className="amount" style={{ color: '#FFA000' }}>{formatCurrency(pendingRefunds)}</p>
                </div>
                ...
                <div className={`card monthly-card ${isDanger ? 'alert-card' : ''}`}>
                    <h3>Month's Balance</h3>
                    <p className="amount" style={{ color: available >= 0 ? 'var(--success)' : '#ff4b4b' }}>
